...
package io.github.thierrysquirrel.web.container.util;
 ...
 * @since JDK21
 **/
public class HttpContainerUtil {
    private HttpContainerUtil() {
    }

    public static void init(HttpRequestContext request) {
        HttpRequestContainer.set(request);
        HttpResponseContainer.set(HttpRequestContextBuilder.builderDefaultResponse());
    }

    public static void delete() {
        HttpRequestContainer.delete();
        HttpResponseContainer.delete();
    }
}
